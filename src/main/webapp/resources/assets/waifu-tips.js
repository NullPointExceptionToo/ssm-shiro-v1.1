...
(function (){
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if (now > 23 || now <= 5) {
            text = '你是夜猫子呀？这么晚还不睡觉，快去睡觉，臭宝宝';
        } else if (now > 5 && now <= 7) {
            text = '早上好！阿宝，一日之计在于晨，美好的一天就要开始了';
        } else if (now > 7 && now <= 11) {
            text = '上午好！工作顺利嘛，不要久坐，多起来走动走动哦！';
        } else if (now > 11 && now <= 14) {
            text = '中午了，工作了一个上午，现在是午餐时间啦！阿宝';
        ...
        if(document.referrer !== ''){
            ...
            if (window.location.hostname == referrer.hostname) {
                text = '欢迎登陆<span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』</span>';
