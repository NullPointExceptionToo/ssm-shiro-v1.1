        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <table class="layui-table"
                ...
                <tr>
                    ...
                    <th lay-data="{field:'homeName',align:'center', width:100, sort: true}">基地名称</th>
                    <th lay-data="{field:'homeUserName', align:'center',width:100, sort: true}">基地负责人</th>
                    <th lay-data="{field:'homeAdds', align:'center',width:200, sort: true}">基地地址</th>
