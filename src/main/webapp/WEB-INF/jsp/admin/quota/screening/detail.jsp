    ...
    <div class="layui-row">
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <div class="x-nav layui-elem-quote">
             ...
             <a><cite><i class="layui-icon" style="line-height:25px">&#xe68e  </i>首页</cite></a>
                <a href="${pageContext.request.contextPath}/admin/quota/screening/index">检查单列表</a>
                <a><cite>检查单详情</cite></a>
            </span>
        ...
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md12">
            <div class="layui-input-inline layui-col-md8" style="width:350px;">
                ...
                <label class="layui-form-label">${screeningVO.hospital}</label>
            </div>
            <div class="layui-input-inline layui-col-md8" style="width:350px;">
                <label class="layui-form-label">检查日期：</label>
                <label class="layui-form-label">${screeningVO.dateTime}</label>
            </div>
        </div>
        <table class="layui-table" lay-skin="line">
            ...
            <tbody>
            <c:forEach items="${screeningVO.quotas}" var="quota">
                <tr>
                    <td>${quota.name}</td>
