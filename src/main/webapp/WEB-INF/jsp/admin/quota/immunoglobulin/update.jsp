    ...
    <div class="layui-row">
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <div class="x-nav layui-elem-quote">
             ...
             <a><cite><i class="layui-icon" style="line-height:25px">&#xe68e  </i>首页</cite></a>
                <a href="${pageContext.request.contextPath}/admin/quota/immunoglobulin/index">免疫球蛋白C3C4测定列表</a>
                <a><cite>修改检查单</cite></a>
            </span>
        ...
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md12">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/quota/immunoglobulin/update/"
                  method="post">
                <input type="text" name="id" value="${immunoglobulinVO.id}" hidden>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">补体C3</label>
                        <div class="layui-input-block">
                            <input type="text" name="bt_c3" lay-verify="digital|required" placeholder="补体C3(mg/dL)"
                                   value="${immunoglobulinVO.bt_c3.value}"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="a_protein" lay-verify="digital|required" placeholder="免疫球蛋白A(mg/dL)"
                                   value="${immunoglobulinVO.a_protein.value}"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">补体C4</label>
                        <div class="layui-input-block">
                            <input type="text" name="bt_c4" lay-verify="digital|required" placeholder="补体C4(mg/dL)"
                                   value="${immunoglobulinVO.bt_c4.value}"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="g_protein" lay-verify="digital|required" placeholder="免疫球蛋白G(mg/dL)"
                                   value="${immunoglobulinVO.g_protein.value}"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="m_protein" lay-verify="digital|required" placeholder="免疫球蛋白M(mg/dL)"
                                   value="${immunoglobulinVO.m_protein.value}"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
