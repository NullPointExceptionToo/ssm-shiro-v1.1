    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md12">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/checkOrder/update/"
                  method="post">
                <input type="text" name="id" value="${checkOrderVO.id}" hidden>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">复查医院</label>
                        <div class="layui-input-block">
                            <input type="text" name="hospital" lay-verify="required" placeholder="hospital"
                                   value="${checkOrderVO.hospital}"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="date" id="date" lay-verify="date|required" placeholder="yyyy-MM-dd"
                                   value="${checkOrderVO.dateTime}"
                ...
                <div class="layui-form-item">
                    <div class="layui-inline" style="width:600px">
                        ...
                        <div class="layui-input-block">
                            <textarea name="medicial" placeholder="请输入内容" value="${checkOrderVO.medicial}" class="layui-textarea"></textarea>
                        </div>
                    </div>
                </div>
