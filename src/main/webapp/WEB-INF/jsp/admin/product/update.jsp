        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <div class="x-nav layui-elem-quote">
             ...
             <a><cite><i class="layui-icon" style="line-height:25px">&#xe68e  </i>首页</cite></a>
                <a href="${pageContext.request.contextPath}/admin/channel/product/index">商品列表</a>
                <a><cite>修改商品</cite></a>
            </span>
            ...
            <a class="layui-btn layui-btn-danger" role="button"
               ...
               href="${pageContext.request.contextPath}/admin/channel/product/index">返回上一级</a>
        </div>
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md6">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/channel/product/update/"
                  method="post">
                <input type="text" name="pid"  placeholder="商品ID" value="${product.pid}" hidden>
                <div class="layui-form-item">
                    <label class="layui-form-label">商品名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="productName" lay-verify="required" placeholder="请输入商品名称"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="productTypeID" lay-verify="required" lay-search="">
                            ...
                            <c:if test="${product.productTypeID == 2}">
                                <option value="0">水果</option>
                                <option value="1">蔬菜</option>
                                <option value="2" selected>五谷</option>
                            </c:if>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="productDes" lay-verify="required" placeholder="请输入商品描述"
