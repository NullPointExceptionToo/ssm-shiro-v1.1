        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <div class="x-nav layui-elem-quote">
             ...
             <a><cite><i class="layui-icon" style="line-height:25px">&#xe68e  </i>首页</cite></a>
                <a href="${pageContext.request.contextPath}/admin/order/proOrder/index">订单列表</a>
                <a><cite>添加订单</cite></a>
            </span>
            ...
            <a class="layui-btn layui-btn-danger" role="button"
               ...
               href="${pageContext.request.contextPath}/admin/order/proOrder/index">返回上一级</a>
        </div>
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md6">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/order/proOrder/add/"
                  method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">生产农户</label>
                    <div class="layui-input-block">
                        <input type="text" name="profarmer" lay-verify="required" placeholder="请输入生产农户"
                               value="${proOrder.profarmer}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">供货数量（斤）</label>
                    <div class="layui-input-block">
                        <input type="text" name="proNum" lay-verify="number required" placeholder="供货数量（斤）"
                               value="${proOrder.proNum}"
                               class="layui-input">
                    </div>
                </div>
